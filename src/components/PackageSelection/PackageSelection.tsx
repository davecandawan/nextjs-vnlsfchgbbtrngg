  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 py-8">
      <div className="flex flex-wrap justify-center items-center gap-6 mt-8">
        ...
        <div className="bg-white rounded-2xl shadow-md overflow-hidden border border-gray-200 w-[320px] flex flex-col order-3 lg:order-1">
          ...
          <div className="pt-0 px-4 pb-4 flex-grow flex flex-col bg-white">
            ...
            <div className="mt-auto">
              <a
                href={getCheckoutUrl('https://secure.vnsh.com/vnlsfchgbbtrngg/starter-checkout')}
                target="_self"
        ...
        >
          <div className="relative w-full h-96 overflow-hidden bg-[#ededed] flex items-center justify-center">
            <Image
              src="/contentimages/AdvancedMobileU2.webp"
              alt="Ultimate Package"
              width={360}
              height={360}
              className="object-contain object-top w-auto h-full"
              priority
            />
          </div>
          <div className="pt-0 px-4 pb-4 flex-grow flex flex-col bg-[#ededed]">
            ...
            <div className="mt-auto">
              <a
                href={getCheckoutUrl('https://secure.vnsh.com/vnlsfchgbbtrngg/advanced-checkout')}
                target="_self"
                rel="noopener noreferrer"
                className="block w-full"
              >
        ...
        >
          <div className="relative w-full h-96 overflow-hidden bg-white flex items-center justify-center">
            <Image
          ...
          <div className="pt-0 px-4 pb-4 flex-grow flex flex-col bg-white">
            ...
            <div className="mt-auto">
              <a
                href={getCheckoutUrl('https://secure.vnsh.com/vnlsfchgbbtrngg/enhanced-checkout')}
                target="_self"
                rel="noopener noreferrer"
                className="block w-full"
              >
